...
// {
//     $labels = array(
//         'name'              => _x( '夢想筆記分類', 'taxonomy general name' ),
//         'singular_name'     => _x( '夢想筆記分類', 'taxonomy singular name' ),
...
//         )
//     );
//     register_taxonomy( 'blog', 'blogs', $args );// Register Taxonomies for Category
//     register_taxonomy_for_object_type('category', 'blog');
//     register_post_type('blogs', // Register Custom Post Type
//         array(
//         'labels' => array(
//             'name' => __('夢想筆記', 'blogs'), // Rename these to suit
//             'singular_name' => __('blogs', 'blogs'),
//             'add_new' => __('新增', 'blogs'),
//             'add_new_item' => __('新增', 'blogs'),
//             'edit' => __('編輯', 'blogs'),
//             'edit_item' => __('編輯', 'blogs'),
//             'new_item' => __('新項目', 'blogs'),
//             'view' => __('檢視', 'blogs'),
//             'view_item' => __('編輯', 'blogs'),
//             'search_items' => __('搜尋', 'blogs'),
//             'not_found' => __('無結果', 'blogs'),
//             'not_found_in_trash' => __('無結果', 'blogs')
//         ),
//         'public' => true,
