    ...
    <section id="kv">
      <figure>
        <section class="container">
          <figcaption>
            <h2 class="fontsize-30"><span>相簿影片</span><span>ALBUM</span></h2>
      ...
      <div class="container">
        <section class="row">
          ...
          <div class="col-lg-9">
            <ul class="row box-list">
              <li class="yellow col-lg-4 col-md-4 col-sm-6 col-xs-6">
                <a target="_blank" href="SimpleViewer" class="box" data-photoset-id="72157651942553096">
                  <figure>
          ...
          <div class="col-lg-3 sidebar hidden-md hidden-sm hidden-xs">
            ...
            <ul class="recent-posts fontsize-reset orange">
              <li>
